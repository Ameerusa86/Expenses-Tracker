...
export function Sidebar({ isMobile = false }: SidebarProps) {
  ...
  const containerClasses = isMobile
    ...
    : 'hidden md:flex md:w-[260px] lg:w-[280px] flex-col border-r border-white/40 bg-white/70 backdrop-blur-xl dark:border-white/10 dark:bg-background/70'
  ...
  return (
    <aside className={containerClasses}>
      <div className={contentClasses}>
        <div className="flex items-center gap-3 rounded-2xl border border-white/40 bg-white/80 px-5 py-4 shadow-sm backdrop-blur dark:border-white/10 dark:bg-background/80">
          <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary/70 text-primary-foreground shadow-glow">
            ...
            <span className="absolute -right-1 -top-1 h-2.5 w-2.5 rounded-full bg-emerald-400 shadow-[0_0_0_3px] shadow-white/80 dark:shadow-background" />
          </div>
          <div>
        ...
        {!isMobile && (
          <div className="mt-6 rounded-2xl border border-white/50 bg-gradient-to-br from-white/90 to-white/60 p-4 shadow-inner dark:border-white/10 dark:from-background/80 dark:to-background/60">
